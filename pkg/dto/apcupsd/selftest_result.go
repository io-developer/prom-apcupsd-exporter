...
var SELFTEST_RESULT_FROM_RAW = map[string]SelftestResult{
	"NA": SELFTEST_RESULT__NA,
	"NO": SELFTEST_RESULT__NONE,
	"NG": SELFTEST_RESULT__FAILED,
	"WN": SELFTEST_RESULT__WARNING,
	"IP": SELFTEST_RESULT__IN_PROGRESS,
	"OK": SELFTEST_RESULT__PASSED,
	"BT": SELFTEST_RESULT__FAILCAP,
	"??": SELFTEST_RESULT__UNKNOWN,
}
